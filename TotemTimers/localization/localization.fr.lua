...
local L = LibStub("AceLocale-3.0"):NewLocale("TotemTimers", "frFR", true, true)
...
L["Leftclick to load totem set to %s"] = "Clic gauche pour charger le set de vos totems sur %s"
...
L["Rightclick to set %s as active multicast spell"] = "Clic droit pour votre set %s comme sorts multicast actifs"
