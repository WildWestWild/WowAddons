...
TotemTimers.options.args.trackers = {
    ...
    args = {
        ...
        trackertimepos = {
            ...
            set = function(info, val)
                        TotemTimers_Settings.TrackerTimePos = val  TotemTimers_ProcessSetting("TrackerTimePos")	
                  end,
        ...
        trackerSize = {
            ...
            bigStep = 2,
            set = function(info, val)
                        TotemTimers_Settings.TrackerSize = val  TotemTimers_ProcessSetting("TrackerSize")	
                  end,
        ...
        trackerTimeHeight = {
            ...
            step = 1,
            set = function(info, val)
                        TotemTimers_Settings.TrackerTimeHeight = val  TotemTimers_ProcessSetting("TrackerTimeHeight")	
                  end,
        ...
        trackertimespacing = {
            ...
            step = 1,
            set = function(info, val)
                        TotemTimers_Settings.TrackerSpacing = val  TotemTimers_ProcessSetting("TrackerSpacing")	
                  end,
        ...
        trackerSpacing = {
            ...
            step = 1,
            set = function(info, val)
                        TotemTimers_Settings.TrackerTimeSpacing = val  TotemTimers_ProcessSetting("TrackerTimeSpacing")	
                  end,
        ...
        trackertimerBarWidth = {
            ...
            step = 4,
            set = function(info, val)
                        TotemTimers_Settings.TrackerTimerBarWidth = val  TotemTimers_ProcessSetting("TrackerTimerBarWidth")	
                  end,
                ...
                ankh = {
                    ...
                    args = {
                        enable = {
                            ...
                            type = "toggle",
                            name = L["Enable"],
                            set = function(info, val) TotemTimers_Settings.AnkhTracker = val  TotemTimers_ProcessSetting("AnkhTracker") end,
                ...
                shield = {
                    ...
                    args = {
                        enable = {
                            ...
                            type = "toggle",
                            name = L["Enable"],
                            set = function(info, val) TotemTimers_Settings.ShieldTracker = val  TotemTimers_ProcessSetting("ShieldTracker") end,
                            get = function(info) return TotemTimers_Settings.ShieldTracker end,
                        },  
                        LeftButton = {
                            order = 2,
                            type = "select",
                            ...
                            set = function(info, val) TotemTimers_Settings.ShieldLeftButton = val  
                                     TotemTimers_ProcessSetting("ShieldLeftButton") end,
                        ...
                        RightButton = {
                            ...
                            set = function(info, val) TotemTimers_Settings.ShieldRightButton = val  
                                     TotemTimers_ProcessSetting("ShieldRightButton") end,
                        ...
                        MiddleButton = {
                            ...
                            set = function(info, val) TotemTimers_Settings.ShieldMiddleButton = val  
                                     TotemTimers_ProcessSetting("ShieldMiddleButton") end,
                    ...
                    args = {
                        enable = {
                            ...
                            set = function(info, val) TotemTimers_Settings.EarthShieldTracker = val 
                                    TotemTimers_ProcessSetting("EarthShieldTracker") end,
                        ...
                        LeftButton = {
                            ...
                            set = function(info, val) TotemTimers_Settings.EarthShieldLeftButton = val  
                                     TotemTimers_ProcessSetting("EarthShieldLeftButton") end,
                        ...
                        RightButton = {
                            ...
                            set = function(info, val) TotemTimers_Settings.EarthShieldRightButton = val  
                                     TotemTimers_ProcessSetting("EarthShieldRightButton") end,
                        ...
                        MiddleButton = {
                            ...
                            set = function(info, val) TotemTimers_Settings.EarthShieldMiddleButton = val  
                                     TotemTimers_ProcessSetting("EarthShieldMiddleButton") end,
                    ...
                    args = {
                        enable = {
                            ...
                            set = function(info, val) TotemTimers_Settings.WeaponTracker = val 
                                    TotemTimers_ProcessSetting("WeaponTracker") end,
                         ...
                         openright = {
                            ...
                            set = function(info, val)
                                    TotemTimers_Settings.WeaponMenuOnRightclick = val  TotemTimers_ProcessSetting("WeaponMenuOnRightclick")
                                end,
                        ...
                        menudirection = {
                            ...
                            set = function(info, val)
                                        TotemTimers_Settings.WeaponBarDirection = val  TotemTimers_ProcessSetting("WeaponBarDirection")	
                                  end,
