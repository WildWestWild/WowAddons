...
L["Menu Key Bindings"] = "Menu du raccourcis clavier"
L["Multicast Button"] = "Appel des totems "
L["MultiCast Keybinds Desc"] = "Affecte les boutons dans le menu de multidiffusion raccourcis clavier 1-3.|nVous devez reconnecter pour que ce paramètre prenne effet."
L["MultiCast Reverse Keybinds Desc"] = "Affecte les raccourcis clavier 9-6, au lieu de 1-3.|nVous devez reconnecter pour que ce paramètre prenne effet."
L["Same as totem menus"] = "Comme les menus du totem"
L["Same as weapon buff menu"] = "Comme le menu du buff d'armes"
