...
L["Menu Direction"] = "토템 메뉴 방향"
L["Menu Key Bindings"] = "메뉴 단축키"
L["Multicast Button"] = "다중시전 버튼"
L["MultiCast Keybinds Desc"] = "1-3까지 다중시전 메뉴의 단축키를 지정합니다.|n이 설정의 효과 적용을 위해 당신은 UI를 재시작 합니다."
L["MultiCast Reverse Keybinds Desc"] = "9-6으로 부터 1-3대신에 단축키를 지정합니다.|n이 설정의 효과 적용을 위해 당신은 UI를 재시작 합니다."
L["Same as totem menus"] = "토템 메뉴와 같이"
L["Same as weapon buff menu"] = "무기 버프 메뉴와 같이"
