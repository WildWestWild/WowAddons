...
local function SetOrder(nr, value)
	...
	TotemTimers_ProcessSetting("Order")
end
...
TotemTimers.options.args.timers = {
    ...
    args = {
         show = {
            ...
            set = function(info, val) TotemTimers_Settings.Show = val  TotemTimers_ProcessSetting("Show") end,
        ...
        time = {
            ...
            set = function(info, val)
                        TotemTimers_Settings.TimeStyle = val  TotemTimers_ProcessSetting("TimeStyle")
                        TotemTimers_Settings.TimeStyle = val  TotemTimers_ProcessSetting("TimeStyle")
                  end,
        ...
        timepos = {
            ...
            set = function(info, val)
                        TotemTimers_Settings.TimerTimePos = val  TotemTimers_ProcessSetting("TimerTimePos")	
                  end,
        ...
        castbuttonpos = {
            ...
            set = function(info, val) TotemTimers_Settings.CastButtonPosition = val TotemTimers_PositionCastButtons() end,
        ...
        menudirection = {
            ...
            set = function(info, val)
                        TotemTimers_Settings.CastBarDirection = val  TotemTimers_PositionCastButtons()	
                  end,
        ...
        timerSize = {
            ...
            bigStep = 2,
            set = function(info, val)
                        TotemTimers_Settings.TimerSize = val  TotemTimers_ProcessSetting("TimerSize")	
                  end,
        ...
        CastButtonSize = {
            ...
            bigStep = 0.2,
            set = function(info, val)
                        TotemTimers_Settings.CastButtonSize = val  TotemTimers_ProcessSetting("CastButtonSize")	
                  end,
        ...
        timerTimeHeight = {
            ...
            step = 1,
            set = function(info, val)
                        TotemTimers_Settings.TimerTimeHeight = val  TotemTimers_ProcessSetting("TimerTimeHeight")	
                  end,
        ...
        spacing = {
            ...
            step = 1,
            set = function(info, val)
                        TotemTimers_Settings.TimerSpacing = val  TotemTimers_ProcessSetting("TimerSpacing")	
                  end,
        ...
        timeSpacing = {
            ...
            step = 1,
            set = function(info, val)
                        TotemTimers_Settings.TimerTimeSpacing = val  TotemTimers_ProcessSetting("TimerTimeSpacing")	
                  end,
        ...
        timerBarWidth = {
            ...
            step = 4,
            set = function(info, val)
                        TotemTimers_Settings.TotemTimerBarWidth = val  TotemTimers_ProcessSetting("TotemTimerBarWidth")	
                  end,
        ...
        openright = {
            ...
            set = function(info, val) TotemTimers_Settings.OpenOnRightclick = val  TotemTimers_ProcessSetting("OpenOnRightclick") end,
        ...
        alwaysopen = {
            ...
            set = function(info, val)
                      ...
                      TotemTimers_ProcessSetting("OpenOnRightclick")
                      TotemTimers_ProcessSetting("MenusAlwaysVisible")
                  end,
        ...
        miniicons = {
            ...
            set = function(info, val) TotemTimers_Settings.MiniIcons = val  TotemTimers_ProcessSetting("MiniIcons") end,
        ...
        procflash = {
            ...
            desc = L["Pulse desc"],
            set = function(info, val) TotemTimers_Settings.ProcFlash = val  TotemTimers_ProcessSetting("ProcFlash") end,
        ...
        ColorTimerBars = {
            ...
            set = function(info, val) TotemTimers_Settings.ColorTimerBars = val  TotemTimers_ProcessSetting("ColorTimerBars") end,
        ...
        ShowCooldowns = {
            ...
            set = function(info, val) TotemTimers_Settings.ShowCooldowns = val  TotemTimers_ProcessSetting("ShowCooldowns") end,
        ...
        PlayerRange = {
            ...
            set = function(info, val) TotemTimers_Settings.CheckPlayerRange = val  TotemTimers_ProcessSetting("CheckPlayerRange") end,
        ...
        RaidRange = {
            ...
            desc = L["Range Desc"],
            set = function(info, val) TotemTimers_Settings.CheckRaidRange = val  TotemTimers_ProcessSetting("CheckRaidRange") end,
        ...
        RaidRangeTooltip = {
            ...
            set = function(info, val) TotemTimers_Settings.ShowRaidRangeTooltip = val  TotemTimers_ProcessSetting("ShowRaidRangeTooltip") end,
